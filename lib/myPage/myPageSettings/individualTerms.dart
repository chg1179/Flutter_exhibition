...
주식회사 아트맵은 고객의 정보를 소중하게 생각하며, ‘정보통신망 이용 촉진 및 정보보호 등에 관한 법률', ‘개인정보보호법’ 등 개인정보보호법령을 철저히 준수합니다.
주식회사 아트맵은 아래와 같은 [개인정보 처리방침]을 제정하고 이를 준수합니다. 또한, 본 개인정보 처리방침은 개인정보와 관련한 법령의 변경이 있는 경우 또는 주식회사 아트맵 정책 변경 등의 이유로 변경 될 수 있습니다. 고객 여러분들께서는 주식회사 아트맵 제공하는 사이트 방문 시 개인정보 처리방침을 수시로 확인하여 주시기 바랍니다.

1. 개인정보의 처리 목적

고객은 사이트 회원 가입시 회원 약관, 개인정보 수집 및 이용 내용에 대해 「동의함」 버튼을 클릭할 수 있는 절차를 마련하여, 「동의함」 버튼을 클릭하면 개인정보 수집 및 이용에 대해 동의한 것으로 봅니다. 주식회사 아트맵은 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다. - 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 서비스 이용 및 상담, 공지사항 전달, 서비스 공급에 따른 금액 결제, 서비스의 공급, 제작상품 연계서비스 제공 등

회사는 이미 동의한 개인의 수집과 이용에 대하여 ⌜취소⌟ 또는 ⌜철회⌟ 기능을 제공함으로써 언제든지 취소하고 삭제할 수 있는 방법을 제공하고 있습니다. 만약, 수집 이용동의를 철회하는 경우에는 해당 서비스의 이용은 불가능합니다.

2. 개인정보의 처리 목적

주식회사 아트맵은 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유 및 이용기간 또는 법령에 따른 개인정보 보유 및 이용기간 내에서 개인정보를 처리, 보유합니다. 고객의 개인정보는 회원탈퇴 등 수집 및 이용목적이 달성되거나 동의철회 요청이 있는 경우 지체없이 파기됩니다. 단, 「전자상거래 등에서의 소비자보호에 관한 법률」 등 관련법령의 규정에 의하여 다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 그 기간 동안 보유합니다.
...
1. 주식회사 아트맵은 다음의 개인정보 항목을 처리하고 있습니다.


분류	유형	수집 및 이용 항목	수집 및 이용 목적	보유 기간
이용자 정보	이용자 식별(회원가입)	[일반회원]이름, 이메일주소[갤러리 관리자]이름, 이메일주소, 상호명, 직책, 휴대폰 번호, [작가]이름, 이메일주소, 비밀번호, 휴대폰 번호	이용자의 식별 및 본인 확인개인전문투자자 적격 확인부정이용 확인·방지회원 서비스 제공서비스 이용에 대한 공지 및 상담민원처리	회원 탈퇴 시 즉시 삭제· 부정이용 방지를 위한 정보(ID, 불량이용 기록)는 탈퇴 DB에서 6개월 후 삭제· 불만 또는 분쟁처리에 관한 기록은 3년간 보관(전자상거래 등에서의 소비자 보호에 관한 법률)
주문/결제	[결제수단 선택에 따른 수집]· 신용카드 : 카드사명, 카드번호(일부) 등· 무통장입금 : 은행명, 입금자명· 현금영수증 발급 정보 : 휴대전화번호, 현금영수증카드정보· 세금계산서 발급 정보 : 전자세금계산서 발급용 이메일, 사업자등록번호, 사업자등록증 사본(이름, 주소, 휴대전화, 이메일)	주문 상품의 결제 및 환불계약사항 및 주문내역 안내 등 고지부정이용 확인·방지 관리	회원 탈퇴 시 즉시 삭제· 부정이용 방지를 위한 고객 식별정보(CI, DI)는 탈퇴 DB에서 6개월 후 삭제· 거래기록 보존을 위해 소비자 식별정보(CI, DI), 결제·취소·환불 및 배송 정보는 5년간 보관(전자상거래 등에서의 소비자 보호에 관한 법률)
환불	예금주 성명, 은행명, 계좌번호
서비스 이용 기록	단말기정보(OS, 화면사이즈, 디바이스 아이디, 폰기종, 단말기 모델명), IP주소, 쿠키, 방문일시, 부정이용기록, 서비스 이용 기록 등	서비스 이용 기록 통계 분석 등 품질 관리/소비자 보호를 위한 법적 의무 준수/부정 이용확인·방지관리/회원 간 분쟁 조정/상품(경품) 발송을 위한 발송정보 확인	회원 탈퇴 시 즉시 삭제· 서비스 이용기록은 3개월간 보관 (통신비밀보호법)·안심번호 서비스 이용기록(음성 녹취 파일)은 1개월간 보관
2. 수집 방법
...
주식회사 아트맵은 고객의 개인정보를 "제1조 개인정보의 수집항목 및 이용목적 "에서 고지한 범위를 넘어 이용하거나 타인 또는 타기업, 기관에 제공하지 않습니다. (정보주체의 동의, 법률의 특별한 규정 등 개인정보보호법 제17조 및 제18조에 해당하는 경우에는 개인정보를 제3자에게 제공할 수 있습니다).
...
업체명	제공하는 항목	제공받는 자의 이용목적	보유 및 이용기간
(주)다날	이름, 전화번호, 카드, 결제 시 카드사 명, 카드번호	결제처리(신용카드, 무통장 입금 및 기타 결제수단)	회원 탈퇴 시, 서비스 종료 시 혹은 위탁 계약 종료 시까지- 부정이용 방지를 위한 고객 식별정보 (CI, DI)는 탈퇴 DB에서 6개월 후 삭제.- 거래기록 보존을 위해 소비자 식별정보(CI, DI), 결제, 취소환불 및 배송 정보는 5년간 보관(전자삼거래 등에서의 소비자보호에 관한 볍률)
NICE평가정보	이름, 전화번호, 개인식별번호	본인인증	회원 탈퇴 시, 서비스 종료 시 혹은 위탁 계약 종료 시까지- 부정이용 방지를 위한 고객 식별정보 (CI, DI)는 탈퇴 DB에서 6개월 후 삭제.- 거래기록 보존을 위해 소비자 식별정보(CI, DI), 결제, 취소환불 및 배송 정보는 5년간 보관(전자삼거래 등에서의 소비자보호에 관한 볍률)
(주)채널코퍼레이션	이름, 이메일, 전화번호	고객 문의 관리	회원 탈퇴 시, 서비스 종료 시 혹은 위탁 계약 종료 시까지- 서비스 이용기록은 3개월간 보관 (통신비밀보호법)- 안심번호 서비스 이용기록(음성 녹취 파일)은 1개월간 보관
스티비 주식회사	이름, 이메일	이메일 발송	회원 탈퇴 시, 서비스 종료 시 혹은 위탁 계약 종료 시까지
KT 클라우드	서비스 이용 기록 또는 수집된 개인 정보	데이터 보관 및 시스템 운영	회원 탈퇴 시, 서비스 종료 시 혹은 위탁 계약 종료 시까지
...
② 개인정보 열람 및 정정을 하고자 할 경우에는 홈페이지 『회원정보』 항목을 클릭하여 직접 열람 또는 정정하거나, 고객센터로 서면, 전화 또는 이메일로 연락하시면 지체 없이 조치하겠습니다. 또한, 회원가입 등을 통해 개인정보의 수집, 이용, 제공에 대해 고객께서 동의하신 내용을 고객께서는 언제든지 철회하실 수 있습니다. 동의 철회를 하고 개인정보를 파기하는 등의 조치를 취한 경우에는 그 사실을 고객께 지체 없이 통지하도록 하겠습니다.
